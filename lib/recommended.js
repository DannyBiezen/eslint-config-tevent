...
module.exports = {
  ...
  rules: {
    "promise/always-return": ["error", { ignoreLastCallback: true }], // The last callback can safely be ignored.
    ...
    "@typescript-eslint/no-unused-vars": [
      ...
      "error",
      {
        argsIgnorePattern: "^_", // Except if they start with _
        varsIgnorePattern: "^_", // Except if they start with _
      },
    ],
    ...
    "no-unused-vars": "off", // Disable this rule as we use the typescript version
